...
public class MediaPlayerApplication {
    ...
    static class PrimaryOperation implements Operation {
        public void execute(String input) {
            System.out.println("Primary Media Player Application service processed: " + input);
        }
    }

    static class SecondaryOperation implements Operation {
        public void execute(String input) {
            System.out.println("Secondary Media Player Application service processed with priority: " + input);
        }
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Media Player Application");
