...
public class TransportTicketBookingSystem {
    ...
    static class PrimaryOperation implements Operation {
        public void execute(String input) {
            System.out.println("Primary Transport Ticket Booking System service processed: " + input);
        }
    }

    static class SecondaryOperation implements Operation {
        public void execute(String input) {
            System.out.println("Secondary Transport Ticket Booking System service processed with priority: " + input);
        }
    }
