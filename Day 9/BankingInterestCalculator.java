...
public class BankingInterestCalculator {
    ...
    static class PrimaryOperation implements Operation {
        public void execute(String input) {
            System.out.println("Primary Banking Interest Calculator service processed: " + input);
        }
    }

    static class SecondaryOperation implements Operation {
        public void execute(String input) {
            System.out.println("Secondary Banking Interest Calculator service processed with priority: " + input);
        }
    }
