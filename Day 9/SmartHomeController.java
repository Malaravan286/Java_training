...
public class SmartHomeController {
    ...
    static class PrimaryOperation implements Operation {
        public void execute(String input) {
            System.out.println("Primary Smart Home Controller service processed: " + input);
        }
    }

    static class SecondaryOperation implements Operation {
        public void execute(String input) {
            System.out.println("Secondary Smart Home Controller service processed with priority: " + input);
        }
    }
