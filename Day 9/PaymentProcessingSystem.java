...
public class PaymentProcessingSystem {
    ...
    static class PrimaryOperation implements Operation {
        public void execute(String input) {
            System.out.println("Primary Payment Processing System service processed: " + input);
        }
    }

    static class SecondaryOperation implements Operation {
        public void execute(String input) {
            System.out.println("Secondary Payment Processing System service processed with priority: " + input);
        }
    }
