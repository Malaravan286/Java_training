...
public class FoodOrderingApplication {
    ...
    static class PrimaryOperation implements Operation {
        public void execute(String input) {
            System.out.println("Primary Food Ordering Application service processed: " + input);
        }
    }

    static class SecondaryOperation implements Operation {
        public void execute(String input) {
            System.out.println("Secondary Food Ordering Application service processed with priority: " + input);
        }
    }
