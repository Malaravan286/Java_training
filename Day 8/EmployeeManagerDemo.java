public class EmployeeManagerDemo {
    public static void main(String[] args) {
        Employee object = new Manager("Sample Manager", 1000.0, "Advanced");
        object.showDetails();
        System.out.println("Objects created: " + Employee.getObjectCount());
    }
}
...
class Manager extends Employee {
    ...
    public Manager(String name, double value, String category) {
        super(name, value);
